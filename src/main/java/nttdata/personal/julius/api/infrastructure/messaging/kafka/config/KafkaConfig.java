package nttdata.personal.julius.api.infrastructure.messaging.kafka.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, TransactionCreatedEvent> consumerFactory() {
        ...
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, TransactionCreatedEvent.class);
